...
<body>
  ...
  <div class="container">
    ...
    <h2>Aquí encontrarás nuestros libros más populares</h2>
    <hr>
    ...
    // Consulta para obtener los 10 libros más vendidos
    $sql = "SELECT titulo, genero, anio_publicacion, ventas, imagen_url FROM libro ORDER BY ventas DESC LIMIT 10";
    ...
    if ($result->num_rows > 0) {
        ...
        while($row = $result->fetch_assoc()) {
            ...
            echo "<img src='" . $row["imagen_url"] . "' alt='Imagen de " . $row["titulo"] . "'>";
            echo "<div>";
            echo "<p><strong>Título:</strong> " . $row["titulo"] . "</p>";
            echo "<p><strong>Género:</strong> " . $row["genero"] . "</p>";
            echo "<p><strong>Año de Publicación:</strong> " . $row["anio_publicacion"] . "</p>";
            echo "</div>";
            echo "<hr>";
            echo "</div>";
        }
    } else {
        echo "<p>No hay libros más vendidos disponibles</p>";
    }
